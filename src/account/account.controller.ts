...
export class AccountController {
  ...
  async findAvailableContactsByAccount(@Query() dto: FilterDto, @Req() req: any): Promise<UserDataRO[]> {
    return await this.accountService.getAvailableContactsByAccount(dto.search, dto.page, dto.take, req?.user);
  }
